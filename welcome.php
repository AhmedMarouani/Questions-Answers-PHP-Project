	...
	<body>
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark navbar-inverse">
			...
			<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
				...
				<a href="" style="text-decoration: none;"><li class="options nav-item nav-link"> Home</li></a>
				<a href="" style="text-decoration: none;"><li class=" options nav-item nav-link"> About </li></a>	
					<div class="nav-item " style="text-decoration: none;" class="options" id="option">
					...
					<a href="" style="text-decoration: none;"><li class="options nav-item nav-link">Contact</li></a>
				</div>
					...
					<div class="input-group search-box dropdown">								
						...
						<ul>
							...
							if(isset($_POST['search'])){
								$query = $_POST['search']; 
								$raw_results =mysqli_query($db, "SELECT question.question FROM question
								WHERE (question LIKE '%$query%') LIMIT 2");
								echo '
								<ul>
									';
									while ($results = MySQLi_fetch_array($raw_results)) {
										...
										<a href="singlequestion.php?question=<?php echo $searchedQuestions; ?>">
